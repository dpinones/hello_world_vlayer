    ...
    <div className="min-h-screen bg-black text-white">
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        {canRegister(currentState) && (
          <div className="bg-zinc-900 rounded-lg p-6 border border-zinc-800 mb-8">
            ...
            <div className="mb-6">
              ...
              <input
                type="text"
                value={registration.handleTiktok}
                onChange={(e) => registration.setHandleTiktok(e.target.value)}
                placeholder="@happy_hasbulla_"
                disabled={registration.isLoading || registerOnChain.isRegistering}
        ...
        {canSubmitProof(currentState) && (
          <div className="bg-zinc-900 rounded-lg p-6 border border-zinc-800 mb-8">
            <h3 className="text-xl font-medium mb-4">Phase 2: Submit Video</h3>
            <p className="text-gray-400 mb-6">
              Submit your TikTok video proof to earn points
            </p>
            ...
            <div className="space-y-4 mb-6">
              <div>
                ...
                <input
                  ...
                  placeholder="@happy_hasbulla_"
                  disabled={submission.isLoading || submitOnChain.isSubmitting}
                  className="w-full px-4 py-3 bg-zinc-800 border border-zinc-700 rounded-md text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50"
                />
              </div>
              ...
              <div>
                ...
                <input
                  type="text"
                  value={submission.urlVideo}
                  onChange={(e) => submission.setUrlVideo(e.target.value)}
                  placeholder="https://www.tiktok.com/@happy_hasbulla_/video/7445559942862261506"
                  disabled={submission.isLoading || submitOnChain.isSubmitting}
                  className="w-full px-4 py-3 bg-zinc-800 border border-zinc-700 rounded-md text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50"
                />
              </div>
